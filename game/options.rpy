...
define config.name = _("StarLight")
...
define config.main_menu_music = "music/v2.ogg"
...
default preferences.text_cps = 10 #change if necessary
...
define config.save_directory = "TEST-1514232891"
...
init python:
    ...
    build.directory_name = "Test.0.0.1,"
